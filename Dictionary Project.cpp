...
//we have added approximately 125000 words into the dictionary 


#include<iostream>
#include<conio.h> //colsole i/o
#include<string.h>
#include<windows.h>//for sleep function in blinking & loading
#include<fstream> //for file handling
using namespace std;
void cover() //Name of Project
{
	system("color b6"); // the colour 
	char x=175;
	char y=174;
	char z=240;
		...
		for(int n=0;n<122;n++)
	{
		...
		cout<<endl;
	cout<<"\n\n\n\n\n\n\n\t\t\tCopyright 2019, Digital Dictionary Class Project, All Rights Reserved.";
	for(int n=0;n<28;n++)
	{
		cout<<".";
		Sleep(350);
...
{	
	...
	file.close();
	     cout<<"\n\n__________________________________________________________________________________________________________________________";
		 cout<<"\t\t\t\tCopyrights 2019, Digital Dictionary Class Project, All Rights Reserved\t Press ENTER to continue";
		 getch();
...
void load()
{
	cout<<endl<<endl<<endl;
	cout<<"\n\n\n\n\n\n\n\t\t\t\t\t\t______________________\n\n";
	cout<<"\t\t\t\t\t\tDIGITAL DICTIONARY PROJECT";	
	cout<<"\n\t\t\t\t\t\t______________________";
	cout<<endl<<endl;
	system("color 70");
 cout<<"\n\t\t\t\t\t\t LOADING ... \n";
...
int main()
	...
	//checking condition to see if history or Search
	menue:
		int X;
		...
		cout<<"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\tMAIN MENU";
		cout<<"\n\t\t\t\t\t\t\t_________\n";
		cout<<"\n\n\t\tPress 1 for SEARCHING, Press 2 for HISTORY, Press 0 to EXIT and then Press ENTER to continue:";
		cin>>X;
		
		if(X==2)//calling history function
		{
		file.close(); //Input file closed here
			cout<<"\n\n\n\n\n\t\t\t";loading();
...
{"cowe","r v. To crouch down tremblingly, as through fear or shame."},
...
{"detes","t v. To dislike or hate with intensity."},
...
{"elasticity","n.That property of matter by which a body tends to return to a former shape afterbeing changed."},
{"electrolysis","n.The process of decomposing a chemical compound by the passage of anelectric current."},
...
{"expatriate","v.To drive from one's own countr"},
...
{"extensor","n.muscle that causes extension."},
...
{"foreclose","v.Tobar by judicial proceedings the equitable right of a mortgagor to redeem property."},
...
{"gratuity","n.That which is given without demand or claim."},
...
{"ntelligence","n. Capacity to know or understand."},
...
{"interval","n. A low tract of land between hills, especially along a river."},
...
{"laxative","adj. Having power to open or loosen the bowels. lea n. A field."},
...
{"lyric"," adj. Fitted for expression in song."},
					//****************************MMMMMMMMMMMMMMMMMM
{"mam-madiha"," the best P.F teacher in the history of K.F.U.E.I.T."},
...
{"maneater","n. An animal that devours human beings."},
...
{"mantle","n. A cloak."},
{"manufacture"," n. A person engaged in manufacturing as a business."},
...
{"mead","n. A meadow."},
{"meager","adj. scanty."},
{"mealymouthed","adj. Afraid to express facts or opinions plainly."},
...
{"narrowminded","adj. Characterized by illiberal views or sentiments."},
...
{"nonexistent","n. That which does not exist."},
{"nonresident","adj. Not residing within a given jurisdiction."},
{"nonchalance","n. A state of mind indicating lack of interest."},
{"noncombatant","n. One attached to the army or navy, but having duties other than that of fighting."},
...
{"obsequious","adj. Showing a servile readiness to fobservance n. A traditional form or customary act."},
...
{"olivebranch","n. A branch of the olive-tree, as an emblem of peace."},
...
{"outoftheway","adj. Remotely situated."},
...
{"overproduction","n. Excessive production.all in with the wishes or will of another."},
...
{"rebuild","v.To build again or a new."},
...
{"sibilate","v.To give a hissing sound to, as in pronouncing the letters."},
...
{"stifle","v.To smother."},
{"stigma","n.A mark of infamy or token of disgrace attaching to a person as the result of evildoing."},
...
{"telepathy"," n.The art or process of communicating by telephone."},
...
{"theocracy"," n.The mixed worship of polytheism."},
...
{"ultramontane","adj.Beyond the mountains, especially beyond the Alps (that is, on their talian side)."},
...
{"underexposed","adj.Insufficiently exposed for proper or full development, as negatives in Photograpyh"},
...
{"usury","n. he demanding for the use of money as a loan, a rate of interest beyond what is allowed by law."},
...
{"zia-ahmed"," Zi.."}
	...
	cout<<"\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\tDICTIONARY";
	cout<<"\n\t\t\t\t\t\t\t__________\n\n";
	cout<<"\n\t\t\t\t\t  For correct results enter the word in lowercase";
...
for(main=0;main<4803;main++)
	...
	cout<<"\n\t\t\t\t\t\t\t______\n\n\n\n\n";
	     ...
	     cout<<"\n\n__________________________________________________________________________________________________________________________";
		 cout<<"\t\t\t\tCopyright 2019, Digital Dictionary Project, All Rights Reserved\t Press ENTER to continue";
		 getch();
	     k=length;main=4803;
	     goto menue;
	  }//output
